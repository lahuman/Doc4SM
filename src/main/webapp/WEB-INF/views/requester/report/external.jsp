...
<script type="text/javascript">
	...
	function report(){
		 location.href="/files/externalWorkReport.do?param="+getForm2Json($('#ff').serializeArray());
	} 
	...
	function success(data, textStatus, jqXHR ){
	 ...
	 var infraList= {};
	 $(function(){
		 callAjax2Json("/requester/code/codeList.json?CODE_MASTER=EWCD", "", function(workData){
			 workCodeList = workData;
			 callAjax2Json("/requester/infra/comboInfraList.json", "", function(infraData){
				 infraList = infraData;
				 
				 callAjax2Json("/requester/company/companyList.json", "", function(companyData){
					 ...
					 callAjax2Json("/requester/user/userList.json", "", function(data){
						...
						$("#dg").datagrid({
							...
							, singleSelect: true
							, toolbar: '#tb'
							, url: '/requester/external/list.json'

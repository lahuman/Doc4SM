...
<script type="text/javascript">
	...
	function success(data, textStatus, jqXHR ){
	 ...
	 var vacationKind = {};
	 $(function(){
			$('#VACATION_USER').combobox('reload', '/user/user/userList.json');
			callAjax2Json("/user/code/codeList.json?CODE_MASTER=VACA", "", function(vacationData){

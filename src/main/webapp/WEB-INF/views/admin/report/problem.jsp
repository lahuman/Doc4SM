...
<script type="text/javascript">
	...
	function success(data, textStatus, jqXHR ){
		 ...
		 if (endEditing()){
            ...
            if (row && $('#dg').datagrid('getSelected').ID != undefined){
            		popupWindow = window.open(
            			"/admin/pop/problemRelation.do?PROBLEM_ID="+row.ID,'popUpWindow','height=510,width=810,left=10,top=10,resizable=no,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no,status=no')
            }else{
	 ...
	 var emergencyList = {};
	 $(function(){
		 callAjax2Json("/admin/code/codeList.json?CODE_MASTER=EMGC", "", function(emergencyData){
...
<body>
	 <!-- Page title -->
      <div class="page-title">
         <div class="container">
            <h2><i class="fa fa-desktop color"></i> PROBLEM <small>문제 출력</small></h2>
            <hr />
         </div>
      </div>
      <!-- Page title -->
         ...
         <div class="container">
			...
			<div class="row">
				...
				<div id="tb" style="height:auto;">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true" onclick="report()">문제리포트저장</a>-
					 &nbsp;&nbsp;&nbsp;&nbsp;

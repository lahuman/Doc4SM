...
<script type="text/javascript">
	 ...
	 function report(){
		 location.href="/files/callReport.do?param="+(getForm2JsonWithEncode($('#ff').serializeArray()));
	 } 
	 function loadGrid(){
	 ...
	 var categoryList = {};
	 $(function(){
		 callAjax2Json("/admin/service/serviceCategoryList.json", "", function(categoryData){
...
<body>
	 <!-- Page title -->
      <div class="page-title">
         <div class="container">
            <h2><i class="fa fa-desktop color"></i> Call <small>단순업무 출력</small></h2>
            <hr />
         </div>
      </div>
      <!-- Page title -->

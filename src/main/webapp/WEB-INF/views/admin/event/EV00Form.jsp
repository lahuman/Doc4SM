...
<table cellpadding="5">
	<tr>
		...
		<label><input TYPE='radio' name='REQ_TYPE' value='S' checked="checked"/>서비스</label>
		<label><input TYPE='radio' name='REQ_TYPE' value='C' />변경</label>
		<label><input TYPE='radio' name='REQ_TYPE' value='O' />장애</label>
		</td>
	</tr>
	<tr >

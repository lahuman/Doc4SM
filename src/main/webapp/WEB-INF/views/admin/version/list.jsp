	...
	function showDetail(){
	    ...
	    if (row && $('#dg').datagrid('getSelected').REVISON != undefined){
	    		popupWindow = window.open(
	    			"/admin/version/pop/showDetail.do?REVISON="+row.REVISON,'popUpWindow','height=450,width=600,left=10,top=10,resizable=no,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no,status=no')
	    }else{
...
<body>
	 <!-- Page title -->
      <div class="page-title">
         <div class="container">
            <h2><i class="fa fa-desktop color"></i> SVN <small>형상관리</small></h2>
            <hr />
         </div>
      </div>
      <!-- Page title -->
			...
			<div class="row">
				...
				<div id="tb" style="height:auto;">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="showDetail()">상세보기</a>-
					  &nbsp;&nbsp;  
				            	위치지정: <input class="easyui-validatebox textbox" name="PATH" id="PATH"  style="width:200px">

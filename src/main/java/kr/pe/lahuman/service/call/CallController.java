...
public class CallController {
	...
	@RequestMapping(value = "/{type}/call.do", method = RequestMethod.GET)
	public String view(@PathVariable("type")String type){
		return type+"/call/list";
	}


	@RequestMapping(value = "/{type}/call/list.json", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/{type}/call/process.do", method = RequestMethod.POST)
	public @ResponseBody DataMap<String, Object> processContract(HttpServletRequest request){
		...
		String message = callService.process(paramList);
